...
public class ListingService { // Business layer
	...
	public void addNewListing(Listing listing){ // POST
		...
		Optional<Listing> listingOptional = listingrepository.findListingByLink(listing.getLink()); //find the listing by link
		
		if(listingOptional.isPresent()) {
			throw new IllegalStateException("Duplicate Listing Link");
		}
